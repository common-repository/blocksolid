...
"use strict";
/*!*****************************************************!*\
  !*** ./src/block-pwd-adjustment-image-alignfull.js ***!
  \*****************************************************/
...
var withAdvancedControls = createHigherOrderComponent(function (BlockEdit) {
  return function (props) {
    ...
    var blocksolidImageAlignFull = attributes.blocksolidImageAlignFull;
    return /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement(BlockEdit, props), isSelected && allowedBlocks.includes(name) && /*#__PURE__*/React.createElement(InspectorControls, null, /*#__PURE__*/React.createElement(PanelBody, null, /*#__PURE__*/React.createElement(ToggleControl, {
      ...
      onChange: function onChange() {
        return setAttributes({
          blocksolidImageAlignFull: !blocksolidImageAlignFull
        });
      },
    ...
    if (allowedBlocks.includes(props.name)) {
      if (props.attributes.blocksolidImageAlignFull) {
        ...
        return /*#__PURE__*/React.createElement(BlockListBlock, _extends({}, props, {
          className: classnames__WEBPACK_IMPORTED_MODULE_0___default()(props.className, 'alignfull')
        }));
      } else {
...
function applyExtraClass(extraProps, blockType, attributes) {
  ...
  if (typeof blocksolidImageAlignFull !== 'undefined' && blocksolidImageAlignFull && allowedBlocks.includes(blockType.name)) {
    extraProps.className = classnames__WEBPACK_IMPORTED_MODULE_0___default()(extraProps.className, 'alignfull');
  }
  return extraProps;
}
...
/******/ })()
;
//# sourceMappingURL=block-pwd-adjustment-image-alignfull.js.map