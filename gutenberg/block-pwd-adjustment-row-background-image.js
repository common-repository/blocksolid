...
"use strict";
/*!**********************************************************!*\
  !*** ./src/block-pwd-adjustment-row-background-image.js ***!
  \**********************************************************/
...
/**
 * Add custom attribute for row background images.
 *
...
/**
 * Add row background image controls on Advanced Block Panel.
 *
...
var withAdvancedControls = createHigherOrderComponent(function (BlockEdit) {
  return function (props) {
    ...
    return /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement(BlockEdit, props), isSelected && allowedBlocks.includes(name) && /*#__PURE__*/React.createElement(InspectorAdvancedControls, null, /*#__PURE__*/React.createElement(PanelBody, {
      title: __('Background Image', 'awp'),
      initialOpen: false
      ...
      render: function render(_ref) {
        ...
        return /*#__PURE__*/React.createElement(Button, {
          ...
          onClick: open
        }, attributes.mediaId == 0 && __('Choose an image', 'awp'), attributes.mediaId != undefined && attributes.mediaUrl && /*#__PURE__*/React.createElement(ResponsiveWrapper
...
var withBackgroundImage = createHigherOrderComponent(function (BlockListBlock) {
  return function (props) {
    if (allowedBlocks.includes(props.name)) {
      if (props.attributes.mediaId) {
        // https://wordpress.stackexchange.com/questions/377256/ - no way to apply the BG as a styles as yet as far as I can see!
        return /*#__PURE__*/React.createElement(BlockListBlock, _extends({}, props, {
          className: classnames__WEBPACK_IMPORTED_MODULE_0___default()(props.className, 'background-image-present')
        }));
        //return <BlockListBlock { ...props } style={{backgroundImage: "url(" + props.attributes.mediaUrl + ")"}}  />;
      } else {
...
wp.hooks.addFilter('editor.BlockListBlock', 'pwd-blocks/with-client-id-class-name', withBackgroundImage);
...
function applyExtraClass(extraProps, blockType, attributes) {
  ...
  //add allowedBlocks restriction
  if (typeof mediaId !== 'undefined' && mediaId && allowedBlocks.includes(blockType.name)) {
    extraProps.className = classnames__WEBPACK_IMPORTED_MODULE_0___default()(extraProps.className, 'background-image-present');
    lodash_assign__WEBPACK_IMPORTED_MODULE_1___default()(extraProps, {
      style: _defineProperty({
        'background-image': extraProps.style ? extraProps.style['background-image'] : ''
...
/******/ })()
;
//# sourceMappingURL=block-pwd-adjustment-row-background-image.js.map